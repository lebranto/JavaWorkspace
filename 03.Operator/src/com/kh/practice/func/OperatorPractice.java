...
public class OperatorPractice {
	...
	public void practice2 ( ) {
		...
		System.out.println(b+ "학년 "+ c + "반 " + d + "번 " + a +" "+ (e == 'M'|| e=='m' ? '남':'여')  + "학생의 성적은 " + f +"이다");
	...
	public void practice3 ( ) {
		...
		//a>13 && a<=19 로 써도 되지만 이미 앞에서 13세 이하는 걸러졌기 때문에 a<= 19 로만 써도 된다.
	...
	public void practice8 ( ) {
		...
		System.out.println("A사원의 연봉 : " + (a + "/" + ap ));
		System.out.println(ap<3000 ? "3000미만" : "3000이상");
		
		System.out.println("B사원의 연봉 : " + (b + "/" + bp ));
		System.out.println(bp<3000 ? "3000미만" : "3000이상");
		
		System.out.println("C사원의 연봉 : " + (a + "/" + cp ));
