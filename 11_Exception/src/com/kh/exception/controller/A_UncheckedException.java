...
public class A_UncheckedException {
	 ...
	 *		ex) p1이 child2 객체로 생성된 참조변수일 때,
	 *			(child1) p1 등의 다운캐스팅을 수행할 경우
	 * 	 4. NullpointerException
	 *		- 참조변수가 null안 상황에서 특정 메서드 및 필드에 접근하려고 할때
	 *		 발생하는 예외  -> null값은 상관 없지만 null. 이 안되는 것
