...
public class MethodReference {
	 ...
	 *    	  String::length;
	 *  - 람다식을 통해 구현한 기능이 이미 저의되어 있는 다른 메서드의 기능을 호출하고,
	...
	public static void main(String[] args) {
		...
		print = System.out::println; //클래스명::메서드명
		print.accept("아자스");
		...
		// 3) 객체 메서드 참조.
		String title = "소나기"; //문자열 객체, 지역변수, 매개변수X, 상수취급, 바꿀 수 없다
		Predicate<String> equalsTotitle;
		equalsTotitle = str -> title.equals(str);

		equalsTotitle = title::equals;   //왼쪽에 객체명을 쓴다.  
